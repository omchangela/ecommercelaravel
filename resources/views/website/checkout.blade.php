                ...
                <div class="card border-0 rounded-0 shadow">
                    <div class="card-header px-0 mx-10 bg-transparent py-8">
                        ...
                        <div class="d-flex w-100 mb-7">
                            ...
                            <div class="d-flex flex-grow-1">
                                <div class="pe-6">
                                    <a href="#" class="">{{ $item->product_name }}<span class="text-body"> x{{ $item->quantity }}</span></a>
                                    <p class="fs-14px text-body-emphasis mb-0 mt-1">Size:
                                        <span class="text-body">{{ $item->unit ?? 'N/A' }}</span>
                                    </p>
                                    @if (!empty($item->color))
                                    <p class="fs-14px text-body-emphasis mb-0 mt-1">Color:
                                        <span class="text-body">{{ $item->color }}</span>
                                    </p>
                                    @endif
                                </div>
                                <div class="ms-auto">
                    ...
                    <div class="card-body px-10 py-8">
                        <div class="d-flex align-items-center mb-2">
                            <span>Subtotal:</span>
                            <span class="d-block ms-auto text-body-emphasis fw-bold">₹{{ number_format($cartItems->sum(fn($item) => $item->price * $item->quantity), 2) }}</span>
                        </div>
                        <div class="d-flex align-items-center">
                            <span>Shipping:</span>
                            <span class="d-block ms-auto text-body-emphasis fw-bold">₹{{ $shippingCost ?? 0 }}</span>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent py-5 px-0 mx-10">
                        <div class="d-flex align-items-center fw-bold mb-6">
                            ...
                            <span class="d-block ms-auto text-body-emphasis fs-4 fw-bold">₹{{ number_format($cartItems->sum(fn($item) => $item->price * $item->quantity) + ($shippingCost ?? 0), 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mb-7">
                        ...
                        <div class="mb-7">
                            ...
                            <input
                                ...
                                min="1"
                                step="0.01"
                                value="{{ number_format($cartItems->sum(fn($item) => $item->price * $item->quantity), 2, '.', '') }}"
                                required>
                            ...
                            .then(data => {
                                if (data.order_id) {
                                    ...
                                    var options = {
                                        ...
                                        image: "{{ asset('assets/website/assets') }}/images/others/logo.png",
