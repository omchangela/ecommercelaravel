		...
		<div class="main-header nav navbar navbar-light navbar-expand-xl py-6 py-xl-0">
			<div class="container-wide container flex-nowrap">
				...
				<a href="/" class="navbar-brand has-sticky-logo py-4 mx-auto w-xl-50">
					<img class="light-mode-img" src="{{ asset('assets/website/assets') }}/images/others/logo.png" width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates">
					...
					<img class="sticky-logo sticky-logo-light" src="{{ asset('assets/website/assets') }}/images/others/logo.png" width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates">
