		...
		<div class="main-header nav navbar navbar-light navbar-expand-xl py-6 py-xl-0">
			<div class="container-wide container flex-nowrap">
				...
				<a href="/" class="navbar-brand has-sticky-logo py-4 mx-auto w-xl-50">
					<img class="light-mode-img " style="padding-left: 40px;" src="{{ asset('assets/website/assets') }}/images/others/logo2.png" width="130" height="46" alt="Glowing - Bootstrap 5 HTML Templates">
					<!-- <img class="dark-mode-img" src="{{ asset('assets/website/assets') }}/images/others/logo-white.png" width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates"> -->
					<img class="sticky-logo sticky-logo-light" style="padding-left: 40px;" src="{{ asset('assets/website/assets') }}/images/others/logo2.png" width="130" height="46" alt="Glowing - Bootstrap 5 HTML Templates">
					<!-- <img class="sticky-logo sticky-logo-dark" src="{{ asset('assets/website/assets') }}/images/others/logo-white.png" width="179" height="26" alt="Glowing - Bootstrap 5 HTML Templates"> -->
