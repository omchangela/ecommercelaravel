        ...
        <div class="row">
            <div class="col-lg-5 mb-12 mb-xl-0 order-lg-1" data-animate="fadeInUp">
                <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
                    ...
                    <img class="lazy-image w-100 img-fluid card-img object-fit-cover banner-02" src="#" data-src="{{ asset('assets/website/assets') }}/images/banner/banner-34.jpg" width="570" height="913" alt="Pamper Your Skin">
                        ...
                        <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
                            <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                                <a href="./shop/product-details-v1.html" class="hover-zoom-in d-block" title="Enriched Duo">
                                    <img src="#" data-src="{{ asset('assets/website/assets') }}/images/products/product-01-330x440.jpg" class="img-fluid lazy-image w-100" alt="Enriched Duo" width="330" height="440">
                                </a>
            ...
            <div class="row gy-30px gx-30px">
                <div class="col-12 col-md-4" data-animate="fadeInUp">
                    <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
                        ...
                        <img class="lazy-image card-img object-fit-cover lazy-image" src="#" data-src="{{ asset('assets/website/assets') }}/images/banner/banner-28.jpg" width="468" height="468" alt="Autumn Skincare">
                ...
                <div class="col-12 col-md-4" data-animate="fadeInUp">
                    <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
                        ...
                        <img class="lazy-image card-img object-fit-cover lazy-image" src="#" data-src="{{ asset('assets/website/assets') }}/images/banner/banner-26.jpg" width="468" height="468" alt="Sale 40% Off">
                        <div class="card-img-overlay d-inline-flex flex-column p-8 justify-content-end text-center">
                ...
                <div class="col-12 col-md-4" data-animate="fadeInUp">
                    <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
                        ...
                        <img class="lazy-image card-img object-fit-cover lazy-image" src="#" data-src="{{ asset('assets/website/assets') }}/images/banner/banner-27.jpg" width="468" height="468" alt="Save on Sets">
                        <div class="card-img-overlay d-inline-flex flex-column p-8 justify-content-end text-center">
            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="slick-slider custom-arrow dot-lg-0" data-slick-options='{"slidesToShow": 1,"infinite":true,"autoplay":true,"dots":false,"arrows":true,"fade":false,"cssEase":"ease-in-out","speed":600, "responsive":[{"breakpoint": 992,"settings": {"slidesToShow":1,"dots":true, "arrows":false }}]}'>
                    <div class="px-6 text-center">
                        <img src="#" data-src="{{ asset('assets/website/assets') }}/images/testimonial/testimonial-10.png" alt="Amazing product. The results are so transformative in texture." class="lazy-image mx-auto mb-11" style="width: 80px; height: 80px">
                    ...
                    <div class="px-6 text-center">
                        <img src="#" data-src="{{ asset('assets/website/assets') }}/images/testimonial/testimonial-11.png" alt="Amazing product. The results are so transformative in texture." class="lazy-image mx-auto mb-11" style="width: 80px; height: 80px">
                        <p class="text-primary fs-3 mb-12 pb-2">“Amazing product. The results are so transformative in texture and my face feels plump and healthy.“</p>
                        <h4 class="fs-15px fw-bold text-uppercase mb-4">Kathleen C.</h4>
                    </div>
                    ...
                    <div class="px-6 text-center">
                        <img src="#" data-src="{{ asset('assets/website/assets') }}/images/testimonial/testimonial-12.png" alt="Amazing product. The results are so transformative in texture." class="lazy-image mx-auto mb-11" style="width: 80px; height: 80px">
                        <p class="text-primary fs-3 mb-12 pb-2">“Amazing product. The results are so transformative in texture and my face feels plump and healthy.“</p>
                        <h4 class="fs-15px fw-bold text-uppercase mb-4">Kathleen C.</h4>
                    </div>
        ...
        <div class="container container-xxl">
            ...
            <div class="mx-n6 slick-slider" data-slick-options='{"slidesToShow": 5,"infinite":false,"autoplay":false,"dots":false,"arrows":false,"responsive":[{"breakpoint": 1366,"settings": {"slidesToShow":5 }},{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 2}},{"breakpoint": 576,"settings": {"slidesToShow": 2}}]}'>
                ...
                <div class="px-6" data-animate="fadeInUp">
                    <a href="{{ asset('assets/website/assets') }}/images/instagram/instagram-01.jpg" title="instagram-01" data-gallery="instagram" class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                ...
                <div class="px-6" data-animate="fadeInUp">
                    <a href="{{ asset('assets/website/assets') }}/images/instagram/instagram-02.jpg" title="instagram-02" data-gallery="instagram" class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                ...
                <div class="px-6" data-animate="fadeInUp">
                    <a href="{{ asset('assets/website/assets') }}/images/instagram/instagram-03.jpg" title="instagram-03" data-gallery="instagram" class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                ...
                <div class="px-6" data-animate="fadeInUp">
                    <a href="{{ asset('assets/website/assets') }}/images/instagram/instagram-04.jpg" title="instagram-04" data-gallery="instagram" class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                ...
                <div class="px-6" data-animate="fadeInUp">
                    <a href="{{ asset('assets/website/assets') }}/images/instagram/instagram-05.jpg" title="instagram-05" data-gallery="instagram" class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
                ...
                <div class="px-6" data-animate="fadeInUp">
                    <a href="{{ asset('assets/website/assets') }}/images/instagram/instagram-06.jpg" title="instagram-06" data-gallery="instagram" class=" hover-zoom-in hover-shine  card-img-overlay-hover hover-zoom-in hover-shine d-block">
