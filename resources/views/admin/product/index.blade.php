...
<div class="page-header page-header-light shadow">
    <div class="page-header-content d-flex">
        ...
        <div class="my-auto ms-auto">
            <a href="{{ route($route . 'create') }}" class="btn btn-success btn-labeled btn-labeled-start text-bold ajax_insert_update">
...
<script>
    $(document).ready(function() {
        var oTable = $('#datatable').DataTable({
            ...
            serverSide: true,
            stateSave: true,
            ajax: '{{ route($route . 'index') }}', // Ensure $route contains the correct prefix like 'product.'
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $("body").on('click', '.ajax_delete', function() {
            ...
            if (confirm("Are you sure to Delete Data?")) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route($route . 'index') }}/" + id, // Ensure route is correct
                    data: {
                        id: id,
                        _token: "{{ csrf_token() }}"
                    },
        ...
        $("body").on("change", ".update_field", function() {
            ...
            $.ajax({
                type: "PUT",
                url: '{{ route($route . 'index') }}/' + row_id, // Ensure correct route
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": row_id,
                    "status": status,
