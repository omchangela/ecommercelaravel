...
<div class="page-header page-header-light shadow">
    <div class="page-header-content d-flex">
        ...
        <div class="my-auto ms-auto">
            <a href="{{ route('admin.privacy.create') }}" class="btn btn-success btn-labeled btn-labeled-start text-bold">
...
<script>
    $(document).ready(function() {
        var oTable = $('#privacyTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.privacy.index') }}', // Your route to fetch privacy
            columns: [{
                    data: 'id',
                    name: 'id'
                },
