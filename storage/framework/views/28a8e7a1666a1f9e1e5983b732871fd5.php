    ...
    <div class="container container-xxl pt-4">
        ...
        <div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 order-3 text-sm-start text-lg-end mt-11 mt-lg-0">
                <img src="#" data-src="<?php echo e(asset('assets/website/assets')); ?>/images/footer/img_1.png" width="313" height="28" alt="Paypal" class="img-fluid lazy-image">
            </div>
        </div>
...
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/bootstrap/js/bootstrap.bundle.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/clipboard/clipboard.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/vanilla-lazyload/lazyload.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/waypoints/jquery.waypoints.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/lightgallery/lightgallery.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/lightgallery/plugins/zoom/lg-zoom.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/lightgallery/plugins/video/lg-video.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/isotope/isotope.pkgd.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/slick/slick.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/gsap/gsap.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/gsap/ScrollToPlugin.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/gsap/ScrollTrigger.min.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/vendors/mapbox-gl/mapbox-gl.js"></script>
<script src="<?php echo e(asset('assets/website/assets')); ?>/js/theme.min.js"></script><?php /**PATH C:\Users\ASUS\Downloads\mark11\resources\views/website/layouts/footer.blade.php ENDPATH**/ ?>