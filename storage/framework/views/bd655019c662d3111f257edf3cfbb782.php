...
<div class="page-header page-header-light shadow">
    <div class="page-header-content d-flex">
        ...
        <div class="my-auto ms-auto">
            <a href="<?php echo e(route('admin.terms.create')); ?>" class="btn btn-success btn-labeled btn-labeled-start text-bold">
...
<script>
    $(document).ready(function() {
        var oTable = $('#termsTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route('admin.terms.index')); ?>', // Your route to fetch terms
            columns: [{
                    data: 'id',
                    name: 'id'
                },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\mark11\resources\views/admin/terms/index.blade.php ENDPATH**/ ?>