...
<main id="content" class="wrapper layout-page">
    ...
    <section>
        <div class="slick-slider hero hero-header-09"
            ...
            <?php $__currentLoopData = $banners->reverse()->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <section id="shop_our_feature_products">
        <div class="container-xxl py-lg-18 pt-14 pb-15 mb-3 mt-1">
            ...
            <div class="row">
                <?php $__currentLoopData = $productBanners->reverse()->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productBanner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-5 mb-10 mb-lg-0" data-animate="fadeInUp">
                    <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
                        <img
                            ...
                            src="#"
                            data-src="<?php echo e(asset('storage/' . $productBanner->image_path)); ?>"
                            width="570"
                            height="913"
    ...
    <section class="bg-section-2 pb-lg-18 pb-16 pt-lg-17 pt-15 mb-4">
        <div class="container container-xxl">
            ...
            <div class="mx-n6 slick-slider"
                ...
                <?php $__currentLoopData = $instagramImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="px-6" data-animate="fadeInUp">
                    <a href="<?php echo e(asset('storage/'.$image->image)); ?>" title="instagram-<?php echo e($loop->index + 1); ?>" data-gallery="instagram"
                        ...
                        <img class="lazy-image img-fluid w-100" width="314" height="314"
                            data-src="<?php echo e(asset('storage/'.$image->image)); ?>" alt="instagram-<?php echo e($loop->index + 1); ?>" src="#">
