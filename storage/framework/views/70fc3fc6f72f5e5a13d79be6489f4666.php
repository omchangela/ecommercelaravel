...
<div class="container">
    ...
    <form action="<?php echo e(route('admin.ingredients.update', $ingredient->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($product->id); ?>" <?php echo e($ingredient->product_id == $product->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div id="keyValueFields">
            <?php $__currentLoopData = $ingredient->ingredients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ingredientValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('key.' . $key, $ingredientValue->key)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('value.' . $key, $ingredientValue->value)); ?>" required>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\mark11\resources\views/admin/ingredients/edit.blade.php ENDPATH**/ ?>