...
<script>
    $(document).ready(function() {
        var oTable = $('#datatable').DataTable({
            ...
            serverSide: true,
            stateSave: true,
            ajax: '<?php echo e(route('admin.orders.index')); ?>', // Your route
            columns: [
                { data: 'id', name: 'id' },
        ...
        $(document).on('change', '.update_field', function() {
            ...
            $.ajax({
                url: '<?php echo e(route('admin.orders.updateDeliveryStatus')); ?>', // This route will call the updateDeliveryStatus method
                method: 'POST',
                data: {
                    order_id: orderId,
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\mark11\resources\views/admin/order/index.blade.php ENDPATH**/ ?>