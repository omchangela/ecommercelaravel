				...
				<a href="/" class="navbar-brand has-sticky-logo py-4 mx-auto w-xl-50">
					...
					<div class="d-none d-xl-flex w-xl-50">
						<ul class="navbar-nav">
							...
							<li class="nav-item transition-all-xl-1 py-xl-11 py-0 me-xxl-12 me-xl-10  dropdown-hover dropdown-fullwidth">
								<a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px"
									href="/" id="menu-item-home" aria-haspopup="true" aria-expanded="false">Home</a>
							</li>
					...
					<div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis">
						...
						<div class="px-5 d-none d-xl-inline-block position-relative">
							<a class="lh-1 color-inherit text-decoration-none" href="#" id="userDropdownToggle" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<!-- Dropdown Menu -->
							<div class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdownToggle" style="min-width: 250px;">
						...
						<div class="px-5 d-none d-xl-inline-block">
							<a class="position-relative lh-1 color-inherit text-decoration-none" href="/wishlist">
								<svg class="icon icon-star-light">
									<use xlink:href="#icon-star-light"></use>
								</svg>
								<span class="badge bg-dark text-white position-absolute top-0 start-100 translate-middle mt-4 rounded-circle fs-13px p-0 square" style="--square-size: 18px">
						...
						<div class="color-modes position-relative ps-5">
							<a class="bd-theme btn btn-link nav-link dropdown-toggle d-inline-flex align-items-center justify-content-center p-0 position-relative rounded-circle" href="#" aria-expanded="true" data-bs-toggle="dropdown" data-bs-display="static" aria-label="Toggle theme (light)">
...
<div id="shoppingCart" class="offcanvas offcanvas-end">
		...
		<form class="table-responsive-md shopping-cart pb-8 pb-lg-10">
			<table class="table table-borderless">
				<tbody>
					...
					<script>
						document.addEventListener('DOMContentLoaded', () => {
							...
							checkoutButton.addEventListener('click', (e) => {
								...
								fetch('<?php echo e(route("cart.updateQuantity")); ?>', {
										method: 'POST',
										headers: {
									...
									.then(data => {
										if (data.success) {
											window.location.href = '<?php echo e(route("checkout.store")); ?>';
										} else {
					...
					<tr class="position-relative cart-item" data-price="<?php echo e($item->price); ?>" data-id="<?php echo e($item->id); ?>">
						<td class="align-middle text-center">
							<form action="<?php echo e(route('cart.destroy', $item->id)); ?>" method="POST" style="display: inline;">
								<?php echo csrf_field(); ?>
								<?php echo method_field('DELETE'); ?>
								<button type="submit" class="btn btn-link p-0 border-0" title="Remove Item">
									<i class="far fa-times"></i>
								</button>
							</form>
						</td>
						<td class="shop-product">
							<div class="d-flex align-items-center">
								<div class="me-3">
									<img src="<?php echo e(asset($item->image_url)); ?>" alt="<?php echo e($item->product_name); ?>" width="60" height="80">
								</div>
								<div>
									<p class="card-text mb-1">
										...
										<span class="fs-13px fw-500 pe-3">/ <?php echo e($item->unit); ?></span>
									</p>
									<p class="fw-500 text-body-emphasis"><?php echo e($item->product_name); ?></p>
								</div>
							</div>
						</td>
						<td class="align-middle p-0">
							<div class="input-group position-relative shop-quantity">
								...
								<input name="quantity[]" type="number" class="form-control form-control-sm px-6 py-4 fs-6 text-center border-0 item-quantity" disabled  value="<?php echo e($item->quantity); ?>" required>
	...
	<div class="offcanvas-footer flex-wrap">
		...
		<a href="<?php echo e(route('checkout.store')); ?>" class="btn btn-dark w-100 mb-7" title="Check Out" id="checkoutButton">Check Out</a>
...
</svg><?php /**PATH C:\Users\ASUS\Downloads\mark11\resources\views/website/layouts/header.blade.php ENDPATH**/ ?>