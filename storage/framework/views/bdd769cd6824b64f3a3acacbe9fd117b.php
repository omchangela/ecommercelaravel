...
<div id="shoppingCart" class="offcanvas offcanvas-end">
					...
					<tr class="position-relative cart-item" data-price="<?php echo e($item->price); ?>" data-id="<?php echo e($item->id); ?>">
							...
							<div class="d-flex align-items-center">
								...
								<div>
									<p class="card-text mb-1">
										<span class="fs-15px item-total fw-bold text-body-emphasis">₹<?php echo e(number_format($item->price * $item->quantity, 2)); ?></span>
						...
						<td class="align-middle p-0">
							<div class="input-group position-relative shop-quantity">
								...
								<input name="quantity[]" type="number" class="form-control form-control-sm px-6 py-4 fs-6 text-center border-0 item-quantity" value="<?php echo e($item->quantity); ?>" required>
	...
	<div class="offcanvas-footer flex-wrap">
		<div class="d-flex align-items-center justify-content-between w-100 mb-5">
			...
			<span id="cart-total" class="cart-total fw-bold text-body-emphasis">₹<?php echo e(number_format($cartItems->sum(fn($item) => $item->price * $item->quantity), 2)); ?></span>
		</div>
